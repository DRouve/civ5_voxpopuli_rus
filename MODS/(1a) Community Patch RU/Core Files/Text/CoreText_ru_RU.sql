...
SET Text = 'Эта опция не используется и ее не следует включать.'
...
UPDATE Language_ru_RU
SET Text = '{1_SpyRank} {2_SpyName} успешно сфальсифицировал местные выборы в городе {3_CityName}. Ваше влияние увеличено на {4_Num}. Влияние других цивилизаций уменьшилось.'
WHERE Tag = 'TXT_KEY_NOTIFICATION_SPY_RIG_ELECTION_SUCCESS';

UPDATE Language_ru_RU
SET Text = 'После недавних выборов ваше влияние в городе {1_CityName} неожиданно сократилось на {2_Num}. Вероятно, это отражает причастность вражеских шпионов к фальсификации местных выборов.'
WHERE Tag = 'TXT_KEY_NOTIFICATION_SPY_RIG_ELECTION_ALERT';

UPDATE Language_ru_RU
SET Text = '{1_SpyRank} {2_SpyName} не удалось сфальсифицировать местные выборы в городе {3_CityName}. {4_CivShortDesc} преуспел в их фальсификации и приобрел там влияние. Ваше влияние уменьшено на {5_Num}.'
...
UPDATE Language_ru_RU
SET Text = 'Их нынешний союзник - {1_CivName:textkey}. Вам понадобится еще ещё {2_NumInfluence} [ICON_INFLUENCE] влияния, чтобы превзойти {1_CivName:textkey} и стать их союзником.[NEWLINE][NEWLINE]Если игрок становится союзником города-государства, он получает дополнительные бонусы, относящиеся к этому городу-государству, а также любые роскошные и стратегические ресурсы, которые принадлежат городу-государству.'
