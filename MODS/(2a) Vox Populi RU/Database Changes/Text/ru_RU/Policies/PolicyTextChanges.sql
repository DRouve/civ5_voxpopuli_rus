...
UPDATE Language_ru_RU
SET Text = '[COLOR_POSITIVE_TEXT]Дипломатическая служба[ENDCOLOR][NEWLINE][ICON_BULLET]Даёт 100 [ICON_VP_SPY_POINTS] очков Шпионажа.[NEWLINE][ICON_BULLET]Награда за задания Городов-государств увеличена на 50%.'
...
UPDATE Language_ru_RU
SET Text = '[COLOR_POSITIVE_TEXT]Теневая сеть[ENDCOLOR][NEWLINE][ICON_BULLET][COLOR_POSITIVE_TEXT]Дружественные[ENDCOLOR] Города-государства дают 25% от производимой ими [ICON_RESEARCH] науки. [NEWLINE][ICON_BULLET]+3% [ICON_CULTURE] культуры в [ICON_CAPITAL] столице за каждые 100 [ICON_VP_SPY_POINTS] очков Шпионажа когда-либо накопленные (максимум 30%).[NEWLINE][ICON_BULLET]+3 [ICON_RESEARCH] науки от Жандармерий и Полицейских Участков.[NEWLINE][ICON_BULLET]+1 [ICON_RESEARCH] науки от специалистов.'
...
UPDATE Language_ru_RU
SET Text = '[COLOR_POSITIVE_TEXT]Подтасовка[ENDCOLOR]: +100 [ICON_VP_SPY_POINTS] очков Шпионажа. При успешной фальсификации выборов в городе-государстве получаемое вами влияние и влияние, которое теряют другие игроки, увеличивается на +50%. Шпионы, размещенные в чужом городе, получают +10 очков сети за ход.'
...
UPDATE Language_ru_RU
SET Text = '[COLOR_POSITIVE_TEXT]Договорная организация[ENDCOLOR]: [ICON_INTERNATIONAL_TRADE] Торговые Пути в Города-государства дают +2 [ICON_INFLUENCE] Влияния за ход за каждый Торговый Маршрут с данным Городом-Государством (максимум +10). +1 [ICON_DIPLOMAT] Делегат во Всемирном конгрессе за каждые 2 [ICON_CITY_STATE] города-государства, изначально существовавшие в мире.'
...
UPDATE Language_ru_RU
SET Text = '[COLOR_POSITIVE_TEXT]Двойные агенты[ENDCOLOR]: +200 [ICON_VP_SPY_POINTS] очков Шпионажа. Получите 125 [ICON_RESEARCH] науки, когда вы обнаруживаете иностранного шпиона (в зависимости от Эры).'
...
UPDATE Language_ru_RU
SET Text = '[COLOR_POSITIVE_TEXT]Большой скачок вперед[ENDCOLOR]: Даёт бесплатную Технологию. Шпионы получают очки сети в два раза быстрее. +1 [ICON_RESEARCH] наука в городах за каждых 3 [ICON_CITIZEN] горожан-неспециалистов.'
...
UPDATE Language_ru_RU
SET Text = '[COLOR_POSITIVE_TEXT]Полицейское государство[ENDCOLOR]: +3 к [ICON_HAPPINESS_1] настроению в городе от Суда, +10 к Городской безопасности от Полицейских Участков. +100% к скорости [ICON_PRODUCTION] постройки Суда и Полицейских Участков.'
...
UPDATE Language_ru_RU
SET Text = '[COLOR_POSITIVE_TEXT]Тирания[ENDCOLOR]: Запугивание [ICON_CITY_STATE] городов-государств больше не снижает [ICON_INFLUENCE] влияние, отменяет Задания, или разрывает Клятвы о защите. При этом [ICON_INFLUENCE] влияние всех других цивилизаций с данным Городом-государством уменьшается на 10% и увеличивает ваше [ICON_INFLUENCE] влияние на 10%.'
