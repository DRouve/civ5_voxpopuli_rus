...
--------------------
UPDATE Language_ru_RU
SET Text = '+1 к [ICON_MOVES] движению морских и погруженных юнитов. -25% к [ICON_GOLD] стоимости обслуживания морских юнитов. Сопротивление шпионам увеличено на 10% во всех городах. [ICON_SPY] Шпионы на 10% эффективнее, перемещаются в любой город за 1 ход, а также считаются на один ранг выше текущего. Начинает игру со [ICON_SPY] шпионом.'
