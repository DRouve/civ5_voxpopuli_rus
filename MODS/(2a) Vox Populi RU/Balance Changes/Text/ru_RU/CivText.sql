...
UPDATE Language_ru_RU
SET Text = 'Уникальный вавилонский {TXT_KEY_UNIT_ARCHER}, который имеет больший урон и наносит дополнительный урон раненым юнитам благодаря повышению [COLOR_POSITIVE_TEXT]{TXT_KEY_PROMOTION_ATLATL_ATTACK}[ENDCOLOR].'
...
--------------------
UPDATE Language_ru_RU
SET Text = 'Бесплатный уникальный египетский [ICON_VP_ARTIFACT] Артефакт после завершения строительства.[NEWLINE][NEWLINE]Завершение [ICON_CARAVAN] сухопутного торгового пути с другой цивилизацией инициирует (или усиляет существующее) [COLOR_POSITIVE_TEXT]Историческое событие[ENDCOLOR].[NEWLINE][NEWLINE]+1 [ICON_GOLD] золота и [ICON_FOOD] еды за каждые 2 клетки Пустыни или Тундры, обработанные городом. [ICON_CARAVAN] Наземные торговые пути получают +50% к радиусу действия и +3 [ICON_GOLD] золота, [ICON_VP_MERCHANT] торговцы в этом городе дают +1 [ICON_GOLD] золота.[NEWLINE][NEWLINE]Рядом [ICON_RES_TRUFFLES] Трюфели: +2 [ICON_GOLD] золота.[NEWLINE]Рядом [ICON_RES_COTTON] Хлопок: +1 к [ICON_PRODUCTION] производству, +1 к [ICON_CULTURE] культуре.[NEWLINE]Рядом [ICON_RES_FUR] Меха: +1 к [ICON_GOLD] золоту, +1 к [ICON_PRODUCTION] производству.'
