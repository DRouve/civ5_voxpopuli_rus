...
--------------------
UPDATE Language_ru_RU
SET Text = 'На 50% больше наград за выполнение заданий [ICON_CITY_STATE] городов-государств. Можно заключать [ICON_RES_MARRIAGE] Браки с Союзными городами-государствами, используя [ICON_GOLD] золото. Пока вы находитесь в мире с городом-государством, Браки увеличивают [ICON_INFLUENCE] минимальный уровень влияния на 200, дают 1 [COLOR_POSITIVE_TEXT]дополнительного[ENDCOLOR] [ICON_DIPLOMAT] делегата Всемирного конгресса и увеличивают скорость появления [ICON_GREAT_PEOPLE] Великих Людей в [ICON_CAPITAL] столице на 15%.'
