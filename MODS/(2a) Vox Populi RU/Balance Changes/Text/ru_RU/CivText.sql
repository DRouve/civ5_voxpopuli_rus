...
SET Text = 'Военные наземные юниты начинают с повышением [COLOR_POSITIVE_TEXT]Дозорный[ENDCOLOR]. Стоимость покупки клеток снижается на 25% и сбрасывается при основании города. Покупка клетки дает +20 [ICON_PRODUCTION] производства (в зависимости от Эры). Может покупать клетки, принадлежащие другим цивилизациям.'
...
UPDATE Language_ru_RU
SET Text = 'Когда вы захватываете город, вы получаете либо технологию, уже известную его владельцу, либо, если это невозможно, большое количество [ICON_RESEARCH] науки. Все [ICON_GREAT_WORK] Шедевры дают +3 [ICON_RESEARCH] науки.'
...
UPDATE Language_ru_RU
SET Text = 'Этот уникальный вавилонский юнит заменяет лучника. Вавилонский лучник сильнее и может лучше противостоять атакам ближнего боя, чем стандартный Лучник. Сразу имеет повышение [COLOR_POSITIVE_TEXT]Стрельба с закрытых позиций[ENDCOLOR].'
...
VALUES ('TXT_KEY_BUILDING_BABYLON_WALLS_HELP', 'Прибавка к [ICON_SILVER_FIST] лимиту военных юнитов от населения данного города увеличена на 10%. Увеличивает [ICON_RANGE_STRENGTH] дальность удара города на 1. Ученые в этом городе дают +2 [ICON_GOLD] золота.[NEWLINE][NEWLINE][ICON_CITY_STATE] Модификатор размера империи в этом городе уменьшен на 5%.');

UPDATE Language_ru_RU
SET Text = 'Стены Вавилона - уникальное вавилонское сооружение, заменяющее стандартные городские стены. Стены Вавилона увеличивают Силу Защиты Города на 15 и Жизни на 75, оба значения намного выше, чем стандартные Стены. Увеличивает [ICON_SILVER_FIST] воинские части, обеспечиваемые населением этого города, на 10% и увеличивает дальность дальнего удара города на 1. Стены Вавилона также предоставляют слот специалиста-ученого и повышают доход золота всех специалистов-ученых. в городе. Также помогает управлять модификатором размера империи в этом городе.'
...
UPDATE Language_ru_RU
SET Text = 'Обладает уникальным набором верований Пантеона, от которых никто другой не может получить выгоду. Собственные города с вашей [ICON_RELIGION] религией не создают и не получают иностранное религиозное давление. +3 [ICON_PEACE] веры в городах, где ваш пантеон или [ICON_RELIGION] религия являются преобладающими.'
...
--------------------
UPDATE Language_ru_RU
SET Text = 'Высадившиеся отряды получают +1 [ICON_MOVES] к движению и тратят всего 1 [ICON_MOVES] движение, чтобы высадиться. Юниты ближнего боя, разведки, конные отряды ближнего боя, пороховые и бронетанковые юниты получают повышение [COLOR_POSITIVE_TEXT]Викинг[ENDCOLOR], а морские юниты ближнего боя получают повышение [COLOR_POSITIVE_TEXT]Барка[ENDCOLOR].'
...
--------------------
UPDATE Language_ru_RU
SET Text = 'Юниты игнорируют стоимость передвижения, когда находятся на Холмах, а также могут пересекать Горы. Города, дороги и железные дороги можно строить на Горах. Горы производят [ICON_RESEARCH] науку, [ICON_GOLD] золото и [ICON_FOOD] еду (в зависимости от Эры).'
...
--------------------
UPDATE Language_ru_RU
SET Text = 'Начинает игру с Пантеоном. [ICON_PROPHET] Великим Пророкам требуется на 35% меньше [ICON_PEACE] веры. После того, как вы создадите [ICON_RELIGION] Религию, все ваши города примут её. Каждый последователь вашей основной [ICON_RELIGION] Религии в городе увеличивает религиозное давление и [ICON_FOOD] рост. [COLOR_NEGATIVE_TEXT]Нельзя создавать [ICON_MISSIONARY] миссионеров.[ENDCOLOR]'
...
--------------------
UPDATE Language_ru_RU
SET Text = '+1 [ICON_CULTURE] культура и [ICON_PEACE] вера от Защитных Зданий и Зданий Военной Подготовки. При появлении [ICON_GREAT_ADMIRAL] Великого Адмирала или [ICON_GREAT_GENERAL] Великого Полководца, вы получаете [ICON_GREAT_WORK] Очки Великого Художника, Писателя и Музыканта в [ICON_CAPITAL] столице.'
...
--------------------
UPDATE Language_ru_RU
SET Text = '+1 [ICON_RESEARCH] наука от специалистов (дополнительно +1 в Средневековье, Индустриальной и Атомной Эре). +30% к скорости появления [ICON_GREAT_PEOPLE] Великих Людей во время [ICON_GOLDEN_AGE] Золотого века и +50 [ICON_GOLDEN_AGE] Очков Золотого века при появлении [ICON_GREAT_PEOPLE] Великих Людей (в зависимости от Эры).'
...
UPDATE Language_ru_RU
SET Text = 'Только майя могут построить этого юнита. Он доступен раньше, чем Композитный лучник, которого он заменяет, и наносит дополнительный урон, когда атакует раненых юнитов.'
WHERE Tag = 'TXT_KEY_UNIT_HELP_MAYAN_ATLATLIST';

UPDATE Language_ru_RU
SET Text = 'Атлатлист — уникальный юнит майя, заменивший составного лучника. Атлатлисты дешевле и доступны раньше, чем составные лучники, и получают дополнительный урон от атаки раненых юнитов. Это преимущество позволяет вашим лучникам использовать тактику ближнего боя.'
...
UPDATE Language_ru_RU
SET Text = '+1 ко всем доходам в [ICON_CAPITAL] столице за каждого уникального [ICON_INTERNATIONAL_TRADE] партнера по торговому пути (в зависимости от Эры). [ICON_INTERNATIONAL_TRADE] Доходы от торговых путей в марокканские города и из них не зависят от расстояния. Может грабить торговые пути между иностранными городами без объявления войны.'
...
--------------------
UPDATE Language_ru_RU
SET Text = '+3 [ICON_CULTURE] культуры и [ICON_GOLD] золота за каждый отдельный ресурс роскоши, который вы импортируете или экспортируете из/в другие цивилизации и [ICON_CITY_STATE] города-государства (в зависимости от Эры). Может импортировать повторяющиеся ресурсы, а импорт от других цивилизаций засчитывается в счет Монополий.'
...
UPDATE Language_ru_RU
SET Text = 'Создает фейторию. Если вы находитесь на территории города-государства, он предоставит вам по одной копии каждого типа ресурса роскоши, связанного с этим городом-государством, независимо от ваших отношений с городом-государством. Также дает защитный бонус.'
...
--------------------
UPDATE Language_ru_RU
SET Text = 'Города-государства могут быть принудительно аннексированы, если от них можно потребовать большую дань. Завоеванные города-государства дают награды, как если бы они были Дружественными (если они милитаристские, они также дают юнитов, как если бы они были Союзными). +15% к скорости [ICON_PRODUCTION] постройки зданий в [ICON_CAPITAL] столице.'
...
--------------------
UPDATE Language_ru_RU
SET Text = '+1 [ICON_PRODUCTION] производства и [ICON_GOLD] золота от Лагерей, Шахт, Лесопилок и Стратегических ресурсов. Позволяет [ICON_RANGE_STRENGTH] дальнему удару города игнорировать линию прямой видимости. Прибавка к [ICON_SILVER_FIST] лимиту военных юнитов от населения данного города увеличена на 10%. Вражеские наземные юниты должны расходовать 1 дополнительное [ICON_MOVES] движение за клетку, если они пересекают клетку, обрабатываемую этим городом.[NEWLINE][NEWLINE][ICON_CITY_STATE] Модификатор размера империи в этом городе уменьшен на 5%.'
...
--------------------
UPDATE Language_ru_RU
SET Text = 'Получение клеток даёт [ICON_PEACE] веру и [ICON_GOLD] золото (в зависимости от Эры). [ICON_INQUISITOR] Инквизиторы открываются раньше, не требуют [ICON_GOLD] золото для обслуживания. Бесплатный [ICON_INQUISITOR] Инквизитор при захвате города. Можно приобретать морские юниты за [ICON_PEACE] веру.'
...
UPDATE Language_ru_RU
SET Text = 'Исследовательский отряд средневековья, специализирующийся на завоевании и заселении передовых городов за границей. Только Испания может построить его. Начинается с промо-акций [COLOR_POSITIVE_TEXT]Overrun[ENDCOLOR] и [COLOR_POSITIVE_TEXT]Vanguard[ENDCOLOR].'
...
UPDATE Language_ru_RU
SET Text = 'Основанные города начинают с дополнительной территорией. Наземные юниты получают боевой бонус, сражаясь на своей территории. Все разведывательные юниты могут выбирать награды в древних руинах.'
...
--------------------
UPDATE Language_ru_RU
SET Text = 'Наземные юниты (ближний бой), разведчики, наездники (ближний бой), пороховые и броненосные юниты получают +20% к [ICON_STRENGTH] боевой мощи при атаке. Осадные юниты получают +1 к [ICON_MOVES] движению. Военные юниты исцеляются и получают +15 ОО, когда появляется [ICON_GREAT_GENERAL] Великий Полководец. Боевой бонус [ICON_GREAT_GENERAL] Великого Полководца увеличен на 15%.'
