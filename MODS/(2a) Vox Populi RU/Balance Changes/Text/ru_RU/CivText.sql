...
--------------------
UPDATE Language_ru_RU
SET Text = 'После завершения [ICON_CARAVAN]/[ICON_CARGO_SHIP] торгового пути с другой цивилизацией, инициируется (или усиливается существующее) [COLOR_POSITIVE_TEXT]Историческое событие[ENDCOLOR], производя [ICON_TOURISM] туризм для указанной цивилизации и треть этого значения для остальных известных цивилизаций.[NEWLINE][NEWLINE] +50% дальность [ICON_CARAVAN] наземных торговых путей. Входящие [ICON_INTERNATIONAL_TRADE] торговые пути приносят +1 [ICON_GOLD] золота для города и +1 [ICON_GOLD] золота для владельца торгового пути.[NEWLINE][NEWLINE]Поблизости [ICON_RES_SPICES] Корица: +1 [ICON_FOOD] еды, + 1 [ICON_PRODUCTION] производство.[NEWLINE]Поблизости [ICON_RES_SUGAR] Сахар: +1 [ICON_FOOD] еды, +1 [ICON_GOLD] золота.'
...
VALUES ('TXT_KEY_BUILDING_BABYLON_WALLS_HELP', 'Прибавка к [ICON_SILVER_FIST] лимиту военных юнитов от населения данного города увеличена на 5%. Увеличивает [ICON_RANGE_STRENGTH] дальность удара города на 1. Великие Ученые предоставляют на 10% больше [ICON_RESEARCH] науки при ускорении исследования технологии.[NEWLINE][NEWLINE][ICON_CITY_STATE] Модификатор размера империи в этом городе уменьшен на 5%.');
...
UPDATE Language_ru_RU
SET Text = 'Внушительный военно-морской юнит классической эпохи, мощный как против городов, так и против других кораблей. Его могут построить только карфагеняне.[NEWLINE][NEWLINE]Получает бесплатно повышения [COLOR_POSITIVE_TEXT]Клещи[ENDCOLOR] и [COLOR_POSITIVE_TEXT]Тяжелый штурм[ENDCOLOR].'
...
SET Text = 'Быстрый юнит дальнего боя, используемый для набегов с отходом. Только гунны могут его построить. Начинается с повышениями [COLOR_POSITIVE_TEXT]Заградительный огонь I[ENDCOLOR] и [COLOR_POSITIVE_TEXT]Фокусированный огонь[ENDCOLOR].'
...
--------------------
UPDATE Language_ru_RU
SET Text = 'Начинает игру с [ICON_RELIGION_PANTHEON] Пантеоном. Для появления [ICON_PROPHET] Великих Пророков требуется на 35% меньше [ICON_PEACE] веры. После того, как вы создадите [ICON_RELIGION] Религию, все ваши города примут её. +10% религиозное давление и +1% [ICON_FOOD] еды за каждого последователя вашей основной [ICON_RELIGION] религии в городе. [COLOR_NEGATIVE_TEXT]Нельзя создавать [ICON_MISSIONARY] миссионеров.[ENDCOLOR]'
...
--------------------
UPDATE Language_ru_RU
SET Text = 'Наездники (дальний бой) получают дополнительную атаку. При запугивании [ICON_CITY_STATE] городов-государств получите все доходы в размере 20% от полученного золота.'
...
UPDATE Language_ru_RU
SET Text = '+1 [ICON_CULTURE] культура за каждый Моаи и город, примыкающий к этому Моаи. Можно строить только рядом с водой.[NEWLINE][NEWLINE]+20% к [ICON_STRENGTH] боевой мощи любых полинезийских юнитов в радиусе 3 клеток.'
WHERE Tag = 'TXT_KEY_BUILD_MOAI_HELP';

UPDATE Language_en_US
SET Text = 'Моаи можно построить только на побережье. Если он построен рядом с другим моаи или городом, он обеспечивает дополнительную [ICON_CULTURE] культуру.[NEWLINE][NEWLINE]Если в пределах 3 клеток от моаи все полинезийские отряды получают +20% [ICON_STRENGTH] боевой мощи.'
...
UPDATE Language_ru_RU
SET Text = '[ICON_INFLUENCE] Влияние на [ICON_CITY_STATE] города-государства начинается с 42. +100% к доходу от Дружественных и Союзных [ICON_CITY_STATE] городов-государств. +25% к [ICON_STRENGTH] боевой мощи [ICON_CAPITAL] столиц Союзных [ICON_CITY_STATE] городов-государств. +10 опыта юнитам, полученным от [ICON_CITY_STATE] городов-государств.'
