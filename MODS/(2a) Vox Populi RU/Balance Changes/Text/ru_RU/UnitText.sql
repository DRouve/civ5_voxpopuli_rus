	...
	UPDATE Language_ru_RU SET Text = 'Если юнит находится на территории города-государства, с которым вы не воюете, это действие приведет к исчезновению юнита.[NEWLINE][NEWLINE]Вы получите большое количество [ICON_GOLD] золота и мгновенное событие «День любви к Отчизне» во всех городах. Каждый город, который вы создали и которым владеете, увеличивает количество золота и продолжительность «Дня любви к Отчизне» на 25%. Юнит исчезнет после этого действия.' WHERE Tag = 'TXT_KEY_MISSION_CONDUCT_TRADE_MISSION_HELP';
	...
	UPDATE Language_ru_RU SET Text = 'Это действие ускорит производство текущего проекта города. Каждый принадлежащий вам Заводской комплекс, который вы создали и которым владеете, увеличивает объем производства на 25%. Юнит исчезнет после этого действия.' WHERE Tag = 'TXT_KEY_MISSION_HURRY_PRODUCTION_HELP';

	UPDATE Language_ru_RU SET Text = 'Великие инженеры могут построить специальное улучшение Заводской комплекс. Когда он обрабатывается, он обеспечивает много [ICON_PRODUCTION] производства для города. Великий инженер также может ускорить подготовку юнитов, постройку зданий или Чудес в городе, что увеличивается на 25% за каждый созданный и принадлежащий вам Заводской комплекс. Великий инженер исчезнет после любого из этих действий.' WHERE Tag = 'TXT_KEY_UNIT_GREAT_ENGINEER_STRATEGY';

	UPDATE Language_ru_RU
	SET Text = '[COLOR_CYAN]Особое улучшение: Заводской комплекс[ENDCOLOR][NEWLINE]Вы можете потратить Великого инженера, чтобы создать Заводской комплекс. Заводской комплекс производит огромное количество производства (молотов) для города, если он обрабатывается.[NEWLINE][NEWLINE][COLOR_CYAN]Особая способность: ускорение производства[ENDCOLOR][NEWLINE]Вы можете потратить Великого инженера, чтобы ускорить производство текущего проекта города. [COLOR_YELLOW]Объем производства равен объёму 5 ходов средних доходов производства лучшего города. Каждый Заводской комплекс, который вы создали и которым владеете, увеличивает это значение на 25%.[ENDCOLOR][NEWLINE][NEWLINE]'
	...
	UPDATE Language_ru_RU SET Text = 'Это действие ускорит исследование текущей технологии. Каждая Академия, которую вы создали и которой владеете, увеличивает количество получаемой науки на 10%. Юнит исчезнет после этого действия.' WHERE Tag = 'TXT_KEY_MISSION_DISCOVER_TECH_HELP';

	UPDATE Language_ru_RU SET Text = 'Великий ученый может построить специальное улучшение Академии, которое при обработке дает много [ICON_RESEARCH] науки. Кроме того, Великий Ученый может дать вам значительный толчок к развитию вашей следующей технологии, увеличенный на 10% за каждую созданную и принадлежащую вам Академию. Великий Ученый исчезнет после любого из этих действий.' WHERE Tag = 'TXT_KEY_UNIT_GREAT_SCIENTIST_STRATEGY';
	...
	-- Inquisitor
	UPDATE Language_ru_RU SET Text = 'Можно купить за [ICON_PEACE] веру в любом городе с преобладающей религией, которая была улучшена. Они могут удалить другие религии из ваших городов (расходуя Инквизитора) или быть размещены внутри города, чтобы уменьшить распространение веры от миссионеров и пророков других цивилизаций в этом городе на 50%. Снятие Ереси вызывает 1 ход сопротивления [ICON_RESISTANCE] в городе.' WHERE Tag = 'TXT_KEY_UNIT_INQUISITOR_STRATEGY';
	
	UPDATE Language_ru_RU SET Text = 'Используется для удаления других религий из городов. Инквизиторы, размещенные в городах, уменьшают распространение веры от иностранных миссионеров и пророков на 50%. Снятие Ереси вызывает 1 ход сопротивления в городе. Можно получить только при покупке за [ICON_PEACE] веру.' WHERE Tag = 'TXT_KEY_UNIT_HELP_INQUISITOR';

	UPDATE Language_ru_RU SET Text = 'Этот приказ устранит присутствие представителей других религий в ближайшем дружественном городе. Вызывает 1 ход сопротивления в городе. Инквизитор исчезнет после этого действия.' WHERE Tag = 'TXT_KEY_MISSION_REMOVE_HERESY_HELP';
	-- Archaeologist Text

	UPDATE Language_ru_RU SET Text = 'У игрока может быть не более [COLOR_POSITIVE_TEXT]3[ENDCOLOR] активных Археологов одновременно. Археологи — это особый подтип рабочих, которые используются для раскопок древностей, улучшения Достопримечательностей или извлечения [ICON_GREAT_WORK] Артефактов для заполнения ячеек [ICON_GREAT_WORK] Шедевров искусства в Музеях, Дворцах, Эрмитажах и некоторых Чудесах. Археологи могут работать на территории, принадлежащей любому игроку. Они исчезают после завершения археологических раскопок. Археологов нельзя купить за [ICON_GOLD] золото, их можно построить только в городе, где есть [COLOR_POSITIVE_TEXT]Государственная школа[ENDCOLOR].' WHERE Tag = 'TXT_KEY_UNIT_HELP_ARCHAEOLOGIST';
