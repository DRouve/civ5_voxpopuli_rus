	...
	-- Great Engineer Text
	INSERT INTO Language_ru_RU (Tag, Text)
	SELECT 'TXT_KEY_BUILD_CONSUMED_HELP_MANUFACTORY', 'Юнит исчезнет.[NEWLINE][NEWLINE]Улучшения клеток Великих Людей соединят Стратегические ресурсы на этой клетке с торговой сетью. Каждый Заводской комплекс усиляет способность Великого Инженера "Ускорение" на 10%.';
	UPDATE Builds SET Help = 'TXT_KEY_BUILD_CONSUMED_HELP_MANUFACTORY' WHERE Type = 'BUILD_MANUFACTORY';

	UPDATE Language_en_US SET Text = 'Этот приказ ускорит производство текущей цели города. Каждый Заводской комплекс, который вы построили (и которым владеете), усиляет данное действие на 10%. Великий Человек исчезнет после этого действия.' WHERE Tag = 'TXT_KEY_MISSION_HURRY_PRODUCTION_HELP';
	...
	SELECT 'TXT_KEY_BUILD_CONSUMED_HELP_ACADEMY', 'Юнит исчезнет.[NEWLINE][NEWLINE]Улучшения клеток Великих Людей соединят Стратегические ресурсы на этой клетке с торговой сетью. Каждая Академия усиляет способность Великого Учёного "Бесплатная наука" на 10%.';
