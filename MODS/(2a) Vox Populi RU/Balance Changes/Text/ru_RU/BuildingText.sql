...
UPDATE Language_ru_RU
SET Text = 'Акведук уменьшает количество [ICON_FOOD] еды, необходимой для увеличения размера города, на 15%. Стройте акведуки в городах, которые вы хотите со временем увеличить.'
WHERE Tag = 'TXT_KEY_BUILDING_AQUEDUCT_STRATEGY';

UPDATE Language_ru_RU
SET Text = '+2 [ICON_CITIZEN] горожанина после постройки. 15% [ICON_FOOD] еды сохраняется после рождения нового [ICON_CITIZEN] горожанина. Учёные, торговцы и инженеры в городе производят +2 к своему базовому доходу.[NEWLINE][NEWLINE]–1 [ICON_HAPPINESS_3] несчастья из-за [ICON_GOLD] Бедности.'
...
VALUES ('TXT_KEY_BUILDING_HOSPITAL_HELP', '+1 [ICON_FOOD] еды за каждые 10 [ICON_CITIZEN] горожан в городе. Каждый ход 5% [ICON_FOOD] еды города конвертируется в [ICON_RESEARCH] науку. Наземные юниты в этом городе восстанавливают 15 ОЗ за ход, вне зависимости от действий юнита.[NEWLINE][NEWLINE]-1 [ICON_HAPPINESS_3] несчастья из-за [ICON_GOLD] Бедности.');
INSERT INTO Language_ru_RU (Tag, Text)
VALUES ('TXT_KEY_BUILDING_TEMPLE_HELP', 'Создает +25% к религиозному давлению. Содержит 1 слот для [ICON_GREAT_WORK] Великого музыкального произведения.[NEWLINE][NEWLINE]–1 [ICON_HAPPINESS_3] несчастье из-за [ICON_RELIGION] религиозных беспорядков.[NEWLINE][NEWLINE]Поблизости [ICON_RES_INCENSE] Благовония: +1 [ICON_CULTURE] Культура , +1 [ICON_GOLD] золота.[NEWLINE]Поблизости [ICON_RES_WINE] Вино: +1 [ICON_CULTURE] Культура, +1 [ICON_GOLD] Золото.[NEWLINE]Рядом [ICON_RES_AMBER] Янтарь: +1 [ICON_CULTURE] Культура, +1 [ ICON_GOLD] Золото.');

INSERT INTO Language_ru_RU (Tag, Text)
VALUES ('TXT_KEY_BUILDING_MONUMENT_HELP', 'Рост границ в городе ускорен на 34%.');

INSERT INTO Language_ru_RU (Tag, Text)
VALUES ('TXT_KEY_BUILDING_AMPHITHEATER_HELP', '+33% к скорости появления [ICON_GREAT_WRITER] Великих Писателей в городе. Все Гильдии писателей производят +1 [ICON_GOLD] золота.[NEWLINE][NEWLINE]Рядом [ICON_RES_DYE] Краска: +1 [ICON_CULTURE] культура, +1 [ICON_GOLD] золото.[NEWLINE]Рядом [ICON_RES_SILK] Шелк: +1 [ICON_CULTURE] культура, +1 [ICON_GOLD] золото.[NEWLINE]Рядом [ICON_RES_LAPIS] Лазурит: +2 [ICON_CULTURE] культура.[NEWLINE]Рядом [ICON_RES_BRAZILWOOD] Бразильское дерево: +1 [ICON_CULTURE] культура, +1 [ICON_GOLD] золото.[NEWLINE][NEWLINE]+2 [ICON_CULTURE] культуры, если Шедевры [COLOR_POSITIVE_TEXT]тематизированы[ENDCOLOR].');
...
INSERT INTO Language_ru_RU (Tag, Text)
VALUES ('TXT_KEY_BUILDING_OPERA_HOUSE_HELP', '+5% к [ICON_CULTURE] культуре в городе. [ICON_GREAT_WORK] Шедевры в городе дают +1 [ICON_TOURISM] туризма. +33% к скорости появления [ICON_GREAT_MUSICIAN] Великих Музыкантов в городе. Все Гильдии музыкантов дают +1 [ICON_GOLD] золота.');
...
UPDATE Language_ru_RU
SET Text = 'Музей — это здание в середине игры, которое увеличивает [ICON_CULTURE] Культуру и [ICON_TOURISM] Туризм и уменьшает Скуку. Также повышает уровень Великого художника города и ценность гильдий художников. Содержит 2 слота для великих произведений искусства. Требуется оперный театр в городе, прежде чем его можно будет построить.'
WHERE Tag = 'TXT_KEY_BUILDING_MUSEUM_STRATEGY';

INSERT INTO Language_ru_RU (Tag, Text)
VALUES ('TXT_KEY_BUILDING_MUSEUM_HELP', '+1 [ICON_CULTURE] культура и [ICON_TOURISM] туризм за каждые 4 [ICON_CITIZEN] горожанина в городе. [ICON_GREAT_WORK] Шедевры в городе дают +1 [ICON_TOURISM] туризма. +33% к скорости появления [ICON_GREAT_ARTIST] Великих Художников в городе. Все Гильдии художников дают +1 [ICON_GOLD] золота.[NEWLINE][NEWLINE]-1 [ICON_HAPPINESS_3] несчастья из-за [ICON_CULTURE] Скуки.[NEWLINE][NEWLINE ]+4 [ICON_CULTURE] культуры, если Шедевры [COLOR_POSITIVE_TEXT]тематизированы[ENDCOLOR].');
...
UPDATE Language_ru_RU
SET Text = 'Шахты, обрабатываемые этим городом, а также специалисты-инженеры получают +2 к [ICON_PRODUCTION] производству.[NEWLINE][NEWLINE]Рядом [ICON_RES_IRON] Железо: +1 [ICON_PRODUCTION] производство, +1 [ICON_GOLD] золото.[NEWLINE]Рядом [ICON_RES_COPPER] Медь: +2 [ICON_GOLD] золото.'
...
UPDATE Language_ru_RU
SET Text = 'Торговая сеть'
WHERE Tag = 'TXT_KEY_GOLD_TRADE_ROUTES_HEADING3_TITLE';

UPDATE Language_ru_RU
SET Text = 'После завершения [ICON_INTERNATIONAL_TRADE] морского Торгового пути с другой цивилизацией, начинается (или усиливается существующее) Историческое событие, производя [ICON_TOURISM] туризм с этой цивилизацией и треть этого значения с остальными цивилизациями.[NEWLINE][][NEWLINE][NEWLINE] +1 [ICON_FOOD] еды от клеток Побережья и Океана и +1 [ICON_PRODUCTION] производства от морских ресурсов, используемых этим городом. Морские торговые пути получают +50% к дальности и +2 [ICON_GOLD] золота.[NEWLINE][NEWLINE]+15% к скорости [ICON_PRODUCTION] подготовки военно-морских юнитов, увеличивает [ICON_SILVER_FIST] лимит военных юнитов на 2 и количество ОЗ города на 150.[NEWLINE][NEWLINE]Можно построить только в прибрежном городе.'
...
INSERT INTO Language_ru_RU (Tag, Text)
VALUES ('TXT_KEY_BUILDING_MARKET_HELP', 'Входящие [ICON_INTERNATIONAL_TRADE] Торговые пути приносят +1 [ICON_GOLD] золота городу и +1 [ICON_GOLD] золота владельцу [ICON_INTERNATIONAL_TRADE] торгового пути.[NEWLINE][NEWLINE]Рядом [ICON_RES_SPICES] Корица: +1 [ICON_FOOD] еда, +1 [ICON_PRODUCTION] производство.[NEWLINE]Рядом [ICON_RES_SUGAR] Сахар: +1 [ICON_FOOD] еда, +1 [ICON_GOLD] золото.');
...
UPDATE Language_ru_RU
SET Text = 'После завершения [ICON_INTERNATIONAL_TRADE] наземного торгового пути с другой цивилизацией начинается (или усиливается существующее) Историческое событие, производя [ICON_TOURISM] туризм с данной цивилизацией и треть этого значения с остальными цивилизациями.[NEWLINE][NEWLINE][NEWLINE] +1 [ICON_FOOD] еда и [ICON_GOLD] золото за каждые 3 клетки Пустыни или 3 клетки Тундры, обрабатываемые городом. Наземные торговые пути получают +50% к радиусу действия и +3 [ICON_GOLD] золота, специалисты-торговцы в этом городе дают +1 [ICON_GOLD] золота.[NEWLINE][NEWLINE]Рядом [ICON_RES_TRUFFLES] Трюфели: +2 [ICON_GOLD] золото.[NEWLINE]Рядом [ICON_RES_COTTON] Хлопок: +1 [ICON_PRODUCTION] производство, +1 [ICON_CULTURE] культура.[NEWLINE]Рядом [ICON_RES_FUR] Меха: +1 [ICON_GOLD] золото, +1 [ICON_PRODUCTION] производство.'
...
UPDATE Language_ru_RU
SET Text = 'Позволяет строить в этом городе [COLOR_YELLOW]Археологов[ENDCOLOR]. +1 [ICON_RESEARCH] науки за каждые 4 [ICON_CITIZEN] горожанина в городе.[NEWLINE][NEWLINE]-1 [ICON_HAPPINESS_3] несчастья из-за [ICON_RESEARCH] Безграмотности.'
...
UPDATE Language_ru_RU
SET Text = 'Город получает +1 [ICON_RESEARCH] науки за каждую клетку Гор в пределах обрабатываемых клеток.[NEWLINE][NEWLINE]Требуется политика [COLOR_MAGENTA]Научная революция[ENDCOLOR].'
WHERE Tag = 'TXT_KEY_BUILDING_OBSERVATORY_HELP';

UPDATE Language_ru_RU
SET Text = 'Обсерватория увеличивает [ICON_RESEARCH] науку, особенно для городов, расположенных рядом с большим количеством гор. Для разблокировки требуется политика «Научная революция».'
...
INSERT INTO Language_ru_RU (Tag, Text)
VALUES ('TXT_KEY_BUILDING_WALLS_HELP', '[ICON_RANGE_STRENGTH] Дальность дальнего удара города увеличивается на 1. Прибавка к [ICON_SILVER_FIST] лимиту военных юнитов от населения данного города увеличена на 10%.[NEWLINE][NEWLINE][ICON_CITY_STATE] Модификатор размера империи в этом городе уменьшен на 5%.');

UPDATE Language_ru_RU
SET Text = 'Замок — это здание средневековой эпохи, которое увеличивает силу защиты и здоровье. Увеличивает воинские части, поставляемые населением этого города, на 10% и увеличивает производство всех ближайших каменоломен на 1. Также помогает управлять модификатором размера империи в этом городе. Город должен уже иметь Стены, прежде чем можно будет построить Замок.'
WHERE Tag = 'TXT_KEY_BUILDING_CASTLE_STRATEGY';

UPDATE Language_ru_RU
SET Text = '+1 [ICON_PRODUCTION] производство для Каменоломень, обрабатываемых городом. Прибавка к [ICON_SILVER_FIST] лимиту военных юнитов от населения данного города увеличена на 10%. Содержит 1 ячейку для [ICON_GREAT_WORK] Шедевра искусства или Артефакта.[NEWLINE][NEWLINE][ICON_CITY_STATE] Модификатор размера империи в этом городе уменьшен на 5%.'
...
UPDATE Language_ru_RU
SET Text = '25% [ICON_CULTURE] культуры от Чудес Света и клеток добавляется к [ICON_TOURISM] туризму города. +25% к [ICON_TOURISM] туризму, получаемому от Шедевров.'
...
INSERT INTO Language_ru_RU (Tag, Text)
VALUES ('TXT_KEY_BUILDING_COLOSSEUM_HELP', '+1 [ICON_TOURISM] туризм за каждых 4 [ICON_CITIZEN] горожан в этом городе. Казармы, Кузница и Оружейная в этом городе получают +2 [ICON_PRODUCTION] производства. -1 [ICON_HAPPINESS_3] несчастье от [ICON_CULTURE] Скуки.[NEWLINE][NEWLINE]Рядом [ICON_RES_PERFUME] Духи: +1 [ICON_GOLD] золото, +1 [ICON_CULTURE] культура.[NEWLINE]Рядом [ICON_RES_OLIVE] Оливки: +1 [ ICON_GOLD] золото, +1 [ICON_FOOD] еда.');
...
UPDATE Language_ru_RU
SET Text = '+500 [ICON_RESEARCH] науки после постройки. Ближайшие клетки Джунглей и Леса получают +1 [ICON_CULTURE] культуры и [ICON_TOURISM] туризма.[NEWLINE][NEWLINE]После завершения [ICON_INTERNATIONAL_TRADE] торгового пути с другой цивилизацией, активируется (или усиливается существующее) Историческое событие, производя [ICON_TOURISM] туризм с этой цивилизацией и треть этого значения с остальными цивилизациями.[NEWLINE][NEWLINE]-1 [ICON_HAPPINESS_3] несчастье от [ICON_CULTURE] Скуки.'
...
UPDATE Language_ru_RU
SET Text = 'Позволяет построить [COLOR_POSITIVE_TEXT]Театр "Глобус"[ENDCOLOR], здание, увеличивающее [ICON_TOURISM] туризм. Также позволяет основать Всемирный конгресс.'
...
UPDATE Language_ru_RU
SET Text = 'Постройте стадион, если вы стремитесь к [COLOR_POSITIVE_TEXT]культурной победе[ENDCOLOR]. По завершении дает огромную сумму очков Золотого века и увеличивает ваше влияние на все города-государства на 20. Координируйте строительство стадионов по всей вашей империи для глобального улучшения дипломатических отношений.'
WHERE Tag = 'TXT_KEY_BUILDING_STADIUM_STRATEGY';

UPDATE Language_ru_RU
SET Text = '+2500 [ICON_GOLDEN_AGE] очков Золотого века и +20 [ICON_INFLUENCE] влияния на все города-государства после постройки. +1 [ICON_GOLDEN_AGE] очко Золотого Века за каждых 2 [ICON_CITIZEN] горожан в городе.[NEWLINE][NEWLINE][ICON_TOURISM] +50% к [ICON_GREAT_WORK] туризму, получаемому от Шедевров. В городе должен быть построен Зоопарк.'
WHERE Tag = 'TXT_KEY_BUILDING_STADIUM_HELP';

UPDATE Language_ru_RU
SET Text = 'Улучшает городскую сопротивляемость [ICON_SPY] шпионской деятельности на 50%. Когда вы успешно противодействуете [ICON_SPY] иностранному шпионажу в этом городе, вы получаете 25 [ICON_CULTURE] культуры и [ICON_GOLD] золота (в зависимости от Эры и ранга иностранного [ICON_SPY] шпиона).[NEWLINE][NEWLINE]-1 [ICON_HAPPINESS_3] несчастье от [ICON_FOOD] и [ICON_PRODUCTION] Бедствия, [ICON_GOLD] Бедности, [ICON_RESEARCH] Неграмотности и [ICON_CULTURE] Скуки.'
WHERE Tag = 'TXT_KEY_BUILDING_POLICE_STATION_HELP';

UPDATE Language_ru_RU
SET Text = 'Повышает городскую сопротивляемость [ICON_SPY] шпионской деятельности на 50%.[NEWLINE][NEWLINE]-1 [ICON_HAPPINESS_3] несчастье от [ICON_FOOD] и [ICON_PRODUCTION] Бедствий.'
...
UPDATE Language_ru_RU
SET Text = 'Это национальное чудо дает +2 [ICON_HAPPINESS_1] счастья, +1 [ICON_CULTURE] культуры, уменьшает [ICON_HAPPINESS_3] Скуку и дает +10% [ICON_CULTURE] культуры и [ICON_GOLD] золота во время «Дня любви к Отечеству» в городе. В городе должна быть построена Арена.'
...
UPDATE Language_ru_RU
SET Text = 'Это национальное чудо дает +1 [ICON_CULTURE] культуры за каждых 4 [ICON_CITIZEN] горожан в городе и дополнительно +10% [ICON_CULTURE] культуры для этого города. В городе должен быть построен Оперный театр.'
WHERE Tag = 'TXT_KEY_BUILDING_HERMITAGE_STRATEGY';

UPDATE Language_ru_RU
SET Text = 'Важное оборонительное национальное чудо для технологической цивилизации. Уменьшает [ICON_HAPPINESS_3] Бедствие во всех городах. Национальное разведывательное управление предоставляет дополнительного шпиона, повышает уровень всех ваших существующих шпионов и повышает городскую сопротивляемость шпионам на 15%. Империи с большим количеством активных шпионов получат большую выгоду от этого здания. В городе должен быть построен Полицейский участок.'
...
UPDATE Language_ru_RU
SET Text = '+10% к [ICON_CULTURE] культуре и [ICON_GOLD] золоту во время «Дня любви к Отечеству» в данном городе. Все Арены дают +2 [ICON_GOLD] золота. -1 [ICON_HAPPINESS_3] несчастье от [ICON_CULTURE] Скуки.[NEWLINE][NEWLINE]Стоимость [ICON_PRODUCTION] производства и требования к [ICON_CITIZEN] населению увеличиваются в зависимости от количества ваших городов.'
...
UPDATE Language_ru_RU
SET Text = 'Повышает городское сопротивление [ICON_SPY] шпионам на 15 %, предоставляет 1 или более [COLOR_POSITIVE_TEXT]дополнительных[ENDCOLOR] [ICON_SPY] шпионов (в зависимости от количества [ICON_CITY_STATE] городов-государств в игре) и повышает уровень всех существующих [ICON_SPY] шпионов. -1 [ICON_HAPPINESS_3] несчастье от [ICON_FOOD] и [ICON_PRODUCTION] Бедствий во всех городах.[NEWLINE][NEWLINE]+100 [ICON_RESEARCH] науки и [ICON_GOLD] золота за успешную в [ICON_SPY] шпионскую операцию в чужом городе (в зависимости от Эры).[NEWLINE][NEWLINE]Стоимость [ICON_PRODUCTION] производства и требования к [ICON_CITIZEN] населению увеличиваются в зависимости от количества ваших городов.'
...
UPDATE Language_ru_RU
SET Text = 'Предоставляет [COLOR_POSITIVE_TEXT]бесплатную[ENDCOLOR] Казарму в городе. Все юниты получают +15% к [ICON_STRENGTH] боевой мощи при нападении на [COLOR_POSITIVE_TEXT]города[ENDCOLOR]. -1 [ICON_HAPPINESS_3] несчастье от [ICON_FOOD] и [ICON_PRODUCTION] Бедствий в этом городе.'
WHERE Tag = 'TXT_KEY_WONDER_STATUE_ZEUS_HELP';

INSERT INTO Language_ru_RU (Tag, Text)
VALUES ('TXT_KEY_BUILDING_STONEHENGE_HELP', 'Дает [COLOR_POSITIVE_TEXT]бесплатный[ENDCOLOR] Совет старейшин и 60 [ICON_PEACE] веры в городе постройки.');
...
UPDATE Language_ru_RU
SET Text = 'Может быть построен только в прибрежном городе. Предоставляет [COLOR_POSITIVE_TEXT]бесплатный[ENDCOLOR] Маяк в городе постройки. Все военно-морские юниты получают +1 к [ICON_MOVES] движению и +1 к обзору.'
...
UPDATE Language_ru_RU
SET Text = 'Предоставляет [COLOR_POSITIVE_TEXT]бесплатный[ENDCOLOR] Мандир в городе постройки. Во всех городах: границы расширяются на 50% быстрее, а стоимость [ICON_GOLD] золота для приобретения новых клеток снижена на 25%.'
WHERE Tag = 'TXT_KEY_WONDER_ANGKOR_WAT_HELP';

UPDATE Language_ru_RU
SET Text = 'Возле города появляется [COLOR_POSITIVE_TEXT]бесплатный[ENDCOLOR] [ICON_GREAT_GENERAL] Великий Полководец. Предоставляет [COLOR_POSITIVE_TEXT]бесплатные[ENDCOLOR] Стены в городе постройки. Вражеские наземные юниты расходуют все очки [ICON_MOVES] движения при входе на вашу территорию. Увеличивает [ICON_SILVER_FIST] лимит военных юнитов на 3. Эти бонусы перестают действовать после изучения [COLOR_NEGATIVE_TEXT]Пороха[ENDCOLOR].'
...
INSERT INTO Language_ru_RU (Tag, Text)
VALUES ('TXT_KEY_BUILDING_NOTRE_DAME_HELP', 'Предоставляет [COLOR_POSITIVE_TEXT]бесплатный[ENDCOLOR] Собор в городе постройки. Империя вступает в [ICON_GOLDEN_AGE] Золотой век. Содержит 2 ячейки для [ICON_GREAT_WORK] Шедевров искусства или Артефактов. +3 [ICON_PEACE] веры и [ICON_GOLDEN_AGE] очков Золотого века, если Шедевры [COLOR_POSITIVE_TEXT]тематизированы[ENDCOLOR].');
...
UPDATE Language_ru_RU
SET Text = 'Возле города появляется [COLOR_POSITIVE_TEXT]бесплатный[ENDCOLOR] [ICON_GREAT_WRITER] Великий Писатель. Писатели, художники и музыканты-специалисты во всех городах дают +2 [ICON_GOLDEN_AGE] очка Золотого века. Содержит 2 ячейки для [ICON_GREAT_WORK] Шедевров литературы. -1 [ICON_HAPPINESS_3] несчастье от [ICON_CULTURE] Скуки в этом городе. 1 специалист в каждом городе больше не вызывает [ICON_HAPPINESS_3] несчастья из-за [ICON_URBANIZATION] урбанизации. +10 [ICON_GOLD] золота, если [COLOR_POSITIVE_TEXT]тематически[ENDCOLOR].'
WHERE Tag = 'TXT_KEY_WONDER_GLOBE_THEATER_HELP';

UPDATE Language_ru_RU
SET Text = 'Получите [COLOR_POSITIVE_TEXT]бесплатно[ENDCOLOR] 1 [ICON_GREAT_ARTIST] великого художника. +1 [ICON_CULTURE] Культура от [ICON_GREAT_WORK] Шедевров во всех городах. Содержит 3 слота для [ICON_GREAT_WORK] Великих произведений искусства. 1 специалист в каждом городе больше не производит [ICON_HAPPINESS_3] несчастье из-за [ICON_URBANIZATION] Урбанизации. +10 [ICON_CULTURE] культуры, если Шедевры [COLOR_POSITIVE_TEXT]тематизированы[ENDCOLOR].'
...
UPDATE Language_ru_RU
SET Text = 'Продолжительность [ICON_GOLDEN_AGE] Золотого века увеличена на 50%. [ICON_CITY_STATE] Модификатор размера империи уменьшен на 10% во всех городах.'
...
UPDATE Language_ru_RU
SET Text = '+10% к [ICON_CULTURE] культуре во всех городах. Содержит 2 ячейки для [ICON_GREAT_WORK] Шедевров искусства. +3 [ICON_PEACE] веры и [ICON_CULTURE] культуры, если Шедевры [COLOR_POSITIVE_TEXT]тематизированы[ENDCOLOR].'
...
UPDATE Language_ru_RU
SET Text = 'Может быть построен только в прибрежном городе. 1 [COLOR_POSITIVE_TEXT]бесплатная[ENDCOLOR] Социальная политика. +25% к [ICON_CULTURE] культуре в этом городе. Содержит 2 ячейки для [ICON_GREAT_WORK] Шедевров музыки. +15 [ICON_CULTURE] культуры, если Шедевры [COLOR_POSITIVE_TEXT]тематизированы[ENDCOLOR].'
...
UPDATE Language_ru_RU
SET Text = 'Внести вклад [ICON_PRODUCTION] производства этого города в проект Всемирной выставки. Стоимость увеличивается в зависимости от количества игроков в игре и текущей эпохи.'
WHERE Tag = 'TXT_KEY_PROCESS_WORLD_FAIR_HELP';

UPDATE Language_ru_RU
SET Text = 'Внести вклад [ICON_PRODUCTION] производства этого города для проекта «Международные игры». Стоимость увеличивается в зависимости от количества игроков в игре и текущей эпохи.'
WHERE Tag = 'TXT_KEY_PROCESS_WORLD_GAMES_HELP';

UPDATE Language_ru_RU
SET Text = 'Внести вклад [ICON_PRODUCTION] производства этого города в проект Международной космической станции. Стоимость увеличивается в зависимости от количества игроков в игре и текущей эпохи.'
