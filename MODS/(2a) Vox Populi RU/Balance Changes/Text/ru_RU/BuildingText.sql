...
UPDATE Language_ru_RU
SET Text = 'Возле города появляется Рабочий. Предоставляет [COLOR_POSITIVE_TEXT]бесплатную[ENDCOLOR] Казарму в городе. Все юниты получают +25% к [ICON_STRENGTH] боевой мощи при нападении на [COLOR_POSITIVE_TEXT]города[ENDCOLOR]. -1 [ICON_HAPPINESS_3] несчастье от [ICON_FOOD] и [ICON_PRODUCTION] Бедствий в этом городе.'
