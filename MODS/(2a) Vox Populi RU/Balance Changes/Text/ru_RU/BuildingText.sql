...
INSERT INTO Language_ru_RU (Tag, Text)
VALUES ('TXT_KEY_BUILDING_MUSEUM_HELP', 'Позволяет подготовку [COLOR_YELLOW]Археологов[ENDCOLOR] в этом городе. +1 [ICON_CULTURE] культура и [ICON_TOURISM] туризм за каждые 4 [ICON_CITIZEN] горожанина в городе. [ICON_GREAT_WORK] Шедевры в городе дают +1 [ICON_TOURISM] туризма.[NEWLINE][NEWLINE]-1 [ICON_HAPPINESS_3] несчастья из-за [ICON_CULTURE] Скуки.[NEWLINE][NEWLINE]Содержит 2 ячейки [ICON_GREAT_WORK] Шедевров искусства или Артефактов. +4 [ICON_CULTURE] культуры, если Шедевры [COLOR_POSITIVE_TEXT]тематизированы[ENDCOLOR].');
