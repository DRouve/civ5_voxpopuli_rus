...
UPDATE Language_ru_RU
SET Text = '{1_RankName} {2_SpyName} пытается сфальсифицировать результаты выборов в {3_CityName}, чтобы усилить там наше влияние. Успешная фальсификация выборов также увеличивает шансы на успех переворота в городе-государстве.'
